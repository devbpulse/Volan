...
[![Build Status](https://img.shields.io/travis/superdevzhao/volan.svg?style=flat-square)](https://travis-ci.org/superdevzhao/parser)
[![Coverage Status](https://img.shields.io/coveralls/superdevzhao/volan/master.svg?style=flat-square)](https://coveralls.io/r/superdevzhao/volan?branch=master)
[![Scrutinizer Code Quality](https://img.shields.io/scrutinizer/g/superdevzhao/volan.svg?style=flat-square)](https://scrutinizer-ci.com/g/superdevzhao/volan/?branch=master)
[![Latest Stable Version](https://poser.pugx.org/superdevzhao/volan/v/stable)](https://packagist.org/packages/superdevzhao/volan)
[![Total Downloads](https://poser.pugx.org/superdevzhao/volan/downloads)](https://packagist.org/packages/superdevzhao/volan)
[![Latest Unstable Version](https://poser.pugx.org/superdevzhao/volan/v/unstable)](https://packagist.org/packages/superdevzhao/volan)
[![License](https://poser.pugx.org/superdevzhao/volan/license)](https://packagist.org/packages/superdevzhao/volan)
...
``` bash
composer require superdevzhao/volan dev-master
```
...
Or with Docker
    ...
    docker run --rm -v "$PWD":/var/src/ superdevzhao/php7 vendor/bin/phpunit --debug


Code style

    docker run --rm -v "$PWD":/var/src/ superdevzhao/php7 vendor/bin/php-cs-fixer fix src
